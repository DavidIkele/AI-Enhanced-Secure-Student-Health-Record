...
--   * Audit logs are append-only (see PROMPT 14) - no UPDATE/DELETE path.
...
-- Login attempt tracking for rate limiting / lockout (PROMPT 3).
...
CREATE TABLE IF NOT EXISTS appointments (
    ...
    -- Application-level overlap detection (PROMPT 6) handles overlapping
...
-- Aggregated illness-pattern / outbreak detection results (PROMPT 10).
...
-- ---------------------------------------------------------------------------
-- AUDIT LOG (append-only; PROMPT 14)
-- ---------------------------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS user_preferences (
    ...
    -- Personalised health insights (PROMPT 11) generated by staff.
    notify_health_insights     TINYINT(1)    NOT NULL DEFAULT 1,
    -- Personal health alerts (PROMPT 13) from authorised clinic staff.
